...
android {
    namespace = "com.noteflow.smart_notes_ai"
    ...
    defaultConfig {
        applicationId = "com.noteflow.smart_notes_ai"
        // minSdk 23 required by Firebase Auth, flutter_secure_storage, Google Sign-In
    ...
    buildTypes {
        release {
            // Enable R8 code shrinking and obfuscation for production
